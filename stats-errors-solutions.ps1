...
Select-String -Path src\uiActions.gs -Pattern "countCommaListValues_"
Select-String -Path html\StatisticsScripts.html -Pattern "Errores mas frecuentes|Errores m.s frecuentes"
