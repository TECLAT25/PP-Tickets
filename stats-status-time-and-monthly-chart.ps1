# stats-status-time-and-monthly-chart.ps1
# Tiempo medio por estado y grafico de tickets abiertos por mes con
# selector de anyo, en Estadisticas.
...
Select-String -Path src\uiActions.gs -Pattern "getUiTicketsCreatedByMonth"
Select-String -Path html\StatisticsScripts.html -Pattern "renderMonthlySection"
