# auto-link-orphan-tickets.ps1
# Al sincronizar, si un hilo de Gmail no coincide con ningun ticket
# existente, busca un ticket sin hilo (mismo cliente + mismo asunto)
# antes de crear uno nuevo, y lo vincula automaticamente.
...
Write-Host "Escribiendo tests\gmailSync.test.js..." -ForegroundColor Cyan
$v3 = @'
'use strict';
...
'@
[System.IO.File]::WriteAllText((Join-Path $root "tests\gmailSync.test.js"), $v3, $enc)
Write-Host "  [OK]" -ForegroundColor Green

Write-Host ""
Write-Host "Verificando..." -ForegroundColor Cyan
Select-String -Path src\gmail.gs -Pattern "findThreadlessTicket_"
