...
PocketPiano ERP is a Google Apps Script application that runs inside Google Workspace.
...
```bash
git clone https://github.com/TECLAT25/PocketPiano-ERP.git
cd PocketPiano-ERP
```
...
- Drive root folder for PocketPiano ERP.
...
- Use the spreadsheet menu: **PocketPiano ERP → Open application**.
