...
```powershell
cd "C:\Users\Josep\Documents\PP-Tickets"
```
...
The example already contains the current PP Tickets Script ID:

```text
1-eCimgHaBPZkqAfBUhehOmZCH7GAH-Uf7wArqtuFynk_ZySVCd3R-Xa8
```
